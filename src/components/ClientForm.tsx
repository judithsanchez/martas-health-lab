    ...
    async function handleSubmit(formData: FormData) {
        ...
        try {
            const data = {
                ...
                activityLevel: formData.get("activityLevel") ? parseInt(formData.get("activityLevel") as string) : null,
                sessionsPerWeek: formData.get("sessionsPerWeek") ? parseInt(formData.get("sessionsPerWeek") as string) : null,
